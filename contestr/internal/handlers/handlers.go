...
func (h *Handlers) GetRegattaContestParticipants(ctx echo.Context, contestId int) error {
	return h.regattaParticipantsHandle.GetContestParticipants(ctx, contestId)
}
